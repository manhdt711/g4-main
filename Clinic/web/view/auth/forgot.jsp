            ...
            <div class="container w-50 p-5 my-5 bg-light rounded-4" style="border: 1px solid #aaa;">
                ...
                <form id="forgot">
                    ...
                    <div class="mb-3 px-3">
                        ...
                        <input type="text" class="form-control" id="email" aria-describedby="emailDes" name="email" placeholder="example@abc.mail" required>
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary my-3 px-3" disabled>Submit</button>
                    </div>
                </form>
            </div>
        </div>
